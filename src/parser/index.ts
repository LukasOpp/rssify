...
export const getPostDataForSelectors = async (
    ...
    const posts: Post[] = postContainers
        .map((i, postContainer) => {
            ...
            const title = selectors.title_selector
                ? getDataForSelector(postElement, selectors.title_selector)
                : undefined;
            let url = selectors.url_selector
                ? getDataForSelector(postElement, selectors.url_selector)
                : undefined;
            ...
            const content = selectors.content_selector
                ? getDataForSelector(postElement, selectors.content_selector)
                : undefined;

            let date = selectors.date_selector
                ? getDataForSelector(postElement, selectors.date_selector)
                : undefined;
            if (date) {
            ...
            let author = selectors.author_selector
                ? getDataForSelector(postElement, selectors.author_selector)
                : undefined;
